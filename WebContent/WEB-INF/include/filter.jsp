...
<%-- Perform queries to get filter lists --%>
<sql:query dataSource="${dbMantis}" var="projectResult">
	 SELECT name FROM mantis_project_table; 
</sql:query>
<sql:query dataSource="${dbMantis}" var="userResult">
 	SELECT username FROM mantis_user_table 
 	WHERE enabled = 1 AND access_level > 54 
